...
Wazuh default rules (`92057` and `92032`) initially flagged the process creation. Custom Rule `100100` was deployed to elevate severity to Level 15 and enforce MITRE taxonomy tagging:
