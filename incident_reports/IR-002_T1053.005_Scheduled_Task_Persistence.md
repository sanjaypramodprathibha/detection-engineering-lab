...
![Scheduled Task Alert Table View](../screenshots/scheduled_task.png)
*Figure 2.1: Scheduled Task creation telemetry (Rule 100101) captured in Discover Table view.*

![Scheduled Task JSON Alert Details](../screenshots/scheduled_task_json.png)
*Figure 2.2: Raw JSON structure showing schtasks command line arguments and process parameters.*
